...
st.markdown("""
<style>
    /* Force Newsletter Aesthetic and Scale Up Fonts */
    .stApp { 
        background: #0d0d12; 
        color: #e2e8f0; 
    ...
    .block-container { max-width: 850px !important; margin: 0 auto !important; padding-top: 1rem; padding-bottom: 3rem; }
    ...
    .badge-bullish  { display: inline-block; padding: 6px 14px; border-radius: 20px; font-size: 12px; font-weight: 700; letter-spacing: 1px; background: #052e16; color: #4ade80; border: 1px solid #166534; }
    .badge-bearish  { display: inline-block; padding: 6px 14px; border-radius: 20px; font-size: 12px; font-weight: 700; letter-spacing: 1px; background: #450a0a; color: #f87171; border: 1px solid #991b1b; }
    .badge-mixed    { display: inline-block; padding: 6px 14px; border-radius: 20px; font-size: 12px; font-weight: 700; letter-spacing: 1px; background: #2d2000; color: #fbbf24; border: 1px solid #92400e; }
    ...
    .inst-name  { font-size: 13px; color: #64748b; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; }
    .inst-level { font-size: 24px; font-weight: 700; color: #f1f5f9; margin: 4px 0 4px; }
    ...
    /* SENTIMENT */
    .sentiment-text { background: #111827; border-left: 4px solid #818cf8; padding: 16px 20px; border-radius: 0 8px 8px 0; margin-top: 20px; font-size: 16px; color: #cbd5e1; line-height: 1.8; }
    .sentiment-line { padding: 12px 0; color: #94a3b8; font-size: 16px; border-bottom: 1px solid #1e293b; }
    ...
    .news-body { font-size: 16px; color: #94a3b8; line-height: 1.65; }

    /* TABLES */
    .custom-table { width: 100%; border-collapse: collapse; font-size: 16px; }
    .custom-table th { font-size: 12px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase; color: #475569; padding: 12px 14px; text-align: left; border-bottom: 1px solid #1e293b; }
    .custom-table td { padding: 14px 14px; border-bottom: 1px solid #1e293b; vertical-align: middle; }
    .custom-table tr:last-child td { border-bottom: none; }
    
    .ticker-cell { font-weight: 700; color: #f1f5f9; font-size: 17px; white-space: nowrap; }
    ...
    .catalyst-cell { font-size: 15px; color: #94a3b8; line-height: 1.6; }

    /* WATCHLIST */
    .watchlist-item { background: #111827; border: 1px solid #1e293b; border-radius: 8px; padding: 18px 20px; margin-bottom: 12px; display: grid; grid-template-columns: 26px 1fr; gap: 12px; align-items: start; }
    .wl-num { font-size: 14px; color: #334155; font-weight: 700; padding-top: 3px; }
    .wl-header { display: flex; align-items: baseline; gap: 10px; margin-bottom: 6px; }
    .wl-ticker { font-size: 20px; font-weight: 800; color: #818cf8; }
    .wl-body   { font-size: 16px; color: #94a3b8; line-height: 1.6; }
    ...
    /* FOOTER */
    .footer-note { background: #111827; border: 1px solid #312e81; border-radius: 10px; padding: 24px 28px; font-size: 16px; color: #94a3b8; line-height: 1.8; }
...
# --- HEADER ---
# Flush left to prevent Markdown code block parsing
...
scorecard_html = """<div class="section">
<div class="section-title">Market Scorecard</div>
<div class="inst-grid">\n"""
...
for name, metrics in macro_data.items():
    ...
    scorecard_html += f"""<div class="inst-card">
...
Equities are testing key algorithmic liquidity zones this morning. Tech and semis continue to carry the broader market higher. The VIX continues to bleed out premium, confirming that fear has decisively faded. Keep a close eye on the 10Y Yield as it interacts with key liquidity zones. 
</div>
</div>"""
...
if sector_data:
    heatmap_html = """<div class="section">
...
<td class="catalyst-cell">Syncing flows</td>
</tr>\n"""
...
<div class="news-headline">T2108 Proxy (Above 40-Day MA) — Recovering Toward Overbought</div>
...
<div>
<div class="wl-header"><span class="wl-ticker">INTC</span><span style="font-size:14px;color:#64748b">Intel Corp</span></div>
...
<div>
<div class="wl-header"><span class="wl-ticker">TSLA</span><span style="font-size:14px;color:#64748b">Tesla Inc</span></div>
...
<div>
<div class="wl-header"><span class="wl-ticker">GEV</span><span style="font-size:14px;color:#64748b">GE Vernova</span></div>
...
# --- FOOTER ---
st.markdown("""<div class="footer-note" style="margin-bottom: 20px;">
<strong>Editor's Note —</strong><br><br>
...
<br><br>
<strong>Market Momentum (MKM)</strong> should be synchronized based on timeframes rather than individual stock symbols. Note that Monday, May 25 is Memorial Day, so markets will be closed. Plan your risk exposure accordingly.
<br><br>
