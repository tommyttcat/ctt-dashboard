...
# Injecting raw CSS to create a responsive, card-based layout
st.markdown("""
<style>
    /* Base App Styling */
    ...
    /* Metrics Grid */
    .metric-grid { display: grid; gap: 10px; margin-bottom: 10px; }
    ...
    .metric-value { color: #FFFFFF; font-size: 16px; font-weight: 600; margin-bottom: 2px; }
    ...
    .custom-table td { padding: 12px 0; border-bottom: 1px solid #1F2430; color: #D1D5DB; }
    .etf-tag { background: #1C243B; color: #60A5FA; padding: 4px 8px; border-radius: 4px; font-family: monospace; font-size: 11px; font-weight: bold;}
    
    /* Editor's Note */
    .editor-note { border: 1px solid #4C1D95; background-color: #1E1B4B; padding: 16px; border-radius: 10px; color: #E5E7EB; font-size: 14px; line-height: 1.6; }
    ...
    @media (min-width: 769px) {
        .block-container { padding-top: 2rem; padding-bottom: 2rem; max-width: 800px; margin: 0 auto; }
...
# ==========================================
# 3. UI GENERATION (HTML LEFT-ALIGNED TO PREVENT MARKDOWN BUGS)
# ==========================================

# Header
date_str = datetime.now().strftime("%A — %B %d, %Y")
st.markdown(f"<h2>Confluence Trading Tools | Daily Briefing</h2>", unsafe_allow_html=True)
...
st.markdown("<div class='section-head'>01 — MACRO SCORECARD</div>", unsafe_allow_html=True)
...
for name, metrics in macro_data.items():
    ...
    # Left-aligned to prevent markdown block interpretation
...
<div style='color: #F87171; font-size: 11px; font-weight: bold; letter-spacing: 1px; margin-bottom: 4px;'>MACRO</div>
<div style='font-size: 14px; color: #FAFAFA;'><strong>PCE Inflation Data</strong> — Comes in line with expectations, easing rate hike fears across the broader market.</div>
</div>
<div style='margin-bottom: 16px; border-top: 1px solid #1F2430; padding-top: 16px;'>
<div style='color: #60A5FA; font-size: 11px; font-weight: bold; letter-spacing: 1px; margin-bottom: 4px;'>EARNINGS</div>
<div style='font-size: 14px; color: #FAFAFA;'><strong>NVDA Blowout</strong> — Announces next-generation server architecture; price target raised by 3 analysts.</div>
</div>
<div style='border-top: 1px solid #1F2430; padding-top: 16px;'>
<div style='color: #A78BFA; font-size: 11px; font-weight: bold; letter-spacing: 1px; margin-bottom: 4px;'>POLICY</div>
<div style='font-size: 14px; color: #FAFAFA;'><strong>Algorithmic Liquidity</strong> — Equities are testing key liquidity zones this morning. Watch the 10Y Yield closely.</div>
</div>
</div>"""
...
editor_html = """<div class='editor-note'>
