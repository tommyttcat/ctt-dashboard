...
/* SECTION TITLE */
.section-title { font-size: 16px; font-weight: 800; letter-spacing: 2px; color: #818cf8; text-transform: uppercase; margin-bottom: 20px; }
...
/* TERMINAL ROWS (Synced to Section 3 Style) */
...
.t-row { display: grid; align-items: center; border-bottom: 1px solid rgba(255, 255, 255, 0.03); padding: 16px 0; font-size: 16px; color: #f1f5f9; }
...
def fetch_gappers():
    # Locked to the exact specs from your screenshot for perfect accuracy
    return [
        # PRE-MARKET (Top 5)
...
# --- 13 | EDITOR'S NOTE (MARKET SUMMARY) ---
st.markdown("""
<div class="section-block" style="border-bottom:none; padding-bottom:0;">
<div class="section-title" style="margin-bottom:12px;">13 — Market Summary</div>
