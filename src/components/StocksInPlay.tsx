            ...
            <table className="w-full min-w-[1200px] table-fixed border-collapse">
              <thead>
                <tr className="border-b border-white/5 select-none">
                  ...
                  <th className="py-3 text-[10px] text-slate-500 font-bold tracking-wider w-[9%] text-left pl-2" onClick={() => handleSort('sector')}>SECTOR{getSortIcon('sector')}</th>
                  <th className="py-3 text-[10px] text-slate-500 font-bold tracking-wider w-[25%] text-left pr-4" onClick={() => handleSort('catalyst')}>CATALYST{getSortIcon('catalyst')}</th>
                </tr>
              </thead>
