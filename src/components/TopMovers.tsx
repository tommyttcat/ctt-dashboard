            ...
            <table className="w-full min-w-[1200px] table-fixed border-collapse">
              <thead>
                <tr className="border-b border-white/5 select-none">
                  ...
                  {!isEtfTab && (
                    <>
                      <th className="py-3 text-[10px] text-slate-500 font-bold tracking-wider cursor-pointer hover:text-slate-300 text-left w-[7%]" onClick={() => handleSort('float')}>FLOAT{getSortIcon('float')}</th>
                      ...
                      <th className="py-3 text-[10px] text-slate-500 font-bold tracking-wider cursor-pointer hover:text-slate-300 text-left w-[7%]" onClick={() => handleSort('mktCap')}>MCAP{getSortIcon('mktCap')}</th>
                    </>
                  )}
                  <th className={`py-3 text-[10px] text-slate-500 font-bold tracking-wider cursor-pointer hover:text-slate-300 text-left pl-2 ${isEtfTab ? 'w-[18%]' : 'w-[9%]'}`} onClick={() => handleSort('sector')}>{isEtfTab ? 'ETF' : 'SECTOR'}{getSortIcon('sector')}</th>
                  <th className={`py-3 text-[10px] text-slate-500 font-bold tracking-wider cursor-pointer hover:text-slate-300 text-left pr-4 ${isEtfTab ? 'w-[36%]' : 'w-[25%]'}`} onClick={() => handleSort('catalyst')}>CATALYST{getSortIcon('catalyst')}</th>
                </tr>
              </thead>
