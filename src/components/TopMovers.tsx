            ...
            <table className="w-full min-w-[1350px] table-fixed border-collapse">
              <thead>
                <tr className="border-b border-white/5 select-none">
                  <th className={`py-3 text-[10px] text-slate-500 font-bold tracking-wider cursor-pointer hover:text-slate-300 text-left pl-2 ${isEtfTab ? 'w-[16%]' : 'w-[12%]'}`} onClick={() => handleSort('ticker')}>TICKER{getSortIcon('ticker')}</th>
